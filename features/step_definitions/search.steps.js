...
When(
  "user click on unoccupied standart seat {string}",
...
When(
  "user click on a buttons to book a ticket and to get a QR-code",
  async function () {
...
When(
  "user click on unoccupied VIP seat if not available click on standart seat",
  async function () {
...
When(
  "user are trying to click on an occupied seat {string}",
  async function (string) {
    return clickElementSeat(this.page, string);
  }
);
